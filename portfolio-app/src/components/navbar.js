...
function Navbar () {
   ...
   return (
    <div className=' w-5/6 m-auto flex flex-row '>
        ...
        {/* menu for mobile*/}
        <div className='ml-40 py-3 md:hidden'>

            {/* Hamburger Menu */}
            <button onClick={toggleMenu} className='w-8 h-8 flex flex-col justify-between cursor-pointer'>
            ...
            {/* Menu Items */}
            <div className={` top-full ml-0 w-full mr-2  overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-screen' : 'max-h-0'}`}>
